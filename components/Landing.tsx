    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50">
      ...
      <section className="max-w-6xl mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-16 text-center">
          ...
          <div>
            <div className="text-4xl font-bold text-red-600">99%</div>
            <p className="text-gray-600">Accuracy Rate</p>
          </div>
          <div>
            <div className="text-4xl font-bold text-red-600">Real-Time</div>
            <p className="text-gray-600">Risk Assessment</p>
          </div>
          <div>
            <div className="text-4xl font-bold text-red-600">5 Roles</div>
